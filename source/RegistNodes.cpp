...
// value
REGIST_NODE_RTTI_DEFAULT(Vector1)
REGIST_NODE_RTTI_DEFAULT(Vector2)
REGIST_NODE_RTTI_DEFAULT(Vector3)
REGIST_NODE_RTTI_DEFAULT(Vector4)
REGIST_NODE_RTTI_DEFAULT(Matrix2)
REGIST_NODE_RTTI_DEFAULT(Matrix3)
REGIST_NODE_RTTI_DEFAULT(Matrix4)
REGIST_NODE_RTTI_DEFAULT(Add)
REGIST_NODE_RTTI_DEFAULT(Mul)
REGIST_NODE_RTTI_DEFAULT(PerspectiveMat)
REGIST_NODE_RTTI_DEFAULT(OrthoMat)
REGIST_NODE_RTTI_DEFAULT(LookAtMat)
